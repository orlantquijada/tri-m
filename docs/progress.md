...
- [x] **4a** — Dashboard (4 totals cards, scoped per role)
- [x] **4b** — Expand seed + end-to-end smoke test
...
- 2026-05-17 — 4b — Expanded seed to 12 customers (Manila-area coords), 9 receivables (3 overdue, 1 fully_paid, 5 current), 8 payments. Dashboard nav links added. Seed ran in WAL mode alongside running API dev server (SQLite allowed concurrent writer).
